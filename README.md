...
local Window = OrionLib:MakeWindow({Name = "Fenix hub 1.0", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Fenix hub 1.0"})
...
W:AddLabel("[+] Fenix hub 1.0 is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Fenix hub 1.0(Noitification)",
